...
func TestAddPolyLine(t *testing.T) {
	...
	//polyline.AddPolyLine([]image.Point{image.Pt(15, 15), image.Pt(385, 15),image.Pt(15, 385),image.Pt(15, 15), image.Pt(385, 385)}, colornames.White, 5)
	polyline.AddPolyLine([]image.Point{image.Pt(20, 20),  image.Pt(385, 385)}, colornames.White, 5)
	polyline.Draw()
